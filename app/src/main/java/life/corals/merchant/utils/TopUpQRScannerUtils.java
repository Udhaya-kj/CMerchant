...
public abstract class TopUpQRScannerUtils {
            ...
            public void receiveDetections(Detector.Detections<Barcode> detections) {
                try {
                    ...
                    if (barCodes.valueAt(0).displayValue.length() > 0 && !scanComplete) {
                        ...
                        qrCodeParserUtils.parseTopUpQR(qrData, merchantId);
                    }
    ...
    public abstract void parsedScanData(HashMap<String, String> stringHashMap, String outletId, String authToken, String campaignId);
