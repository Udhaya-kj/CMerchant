...
public class CashTopupScreenSuccess extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = CashTopupScreenSuccess.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appTimeOutManagerUtil = new AppTimeOutManagerUtil(CashTopupScreenSuccess.this);
        this.setRequestedOrientation(
                ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
